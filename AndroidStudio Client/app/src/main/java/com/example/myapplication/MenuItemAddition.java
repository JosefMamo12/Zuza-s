...
public class MenuItemAddition extends AppCompatActivity implements View.OnClickListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        TextView banner = findViewById(R.id.add_item_header);
        banner.setOnClickListener(this);

        editName = findViewById(R.id.add_item_name);
        editDescription = findViewById(R.id.add_item_description);

        // Get a reference to the AutoCompleteTextView in the layout
        // Make category section autocomplete based on existing categories.
        editCategory = findViewById(R.id.add_item_category);
        ...
        editPrice = findViewById(R.id.add_item_price);
    }
