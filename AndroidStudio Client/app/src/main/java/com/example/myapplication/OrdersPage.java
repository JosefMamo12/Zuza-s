...
public class OrdersPage extends AppCompatActivity implements View.OnClickListener, UpdateMenuRecyclerView
    {
                    ...
                    .addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot)
                        {
                            for (DataSnapshot data : snapshot.getChildren())
                            {
                                ...
                                cartAdapter = new com.example.myapplication.CartPage.CartPageAdapter(items, itemsCount, temp_ctx);
        ...
        {
            cartAdapter = new com.example.myapplication.CartPage.CartPageAdapter(items, itemsCount, this);
